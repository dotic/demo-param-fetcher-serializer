...
export class Migration1689682616941 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "person" ("email", "givenName", "id", "surname") VALUES ('email1@email.local', 'Fetcher', 'e5ce4fdb-1a02-44d9-a9cc-26f48bef26ee', 'Fetch')`,
    );
    await queryRunner.query(
      `INSERT INTO "person" VALUES ('email2@email.local', 'Param', '3827a8dc-d84d-4711-a934-9da17e859669', 'Pr')`,
    );
  }
